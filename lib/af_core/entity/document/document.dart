...
class Document {
  late List<Dokuments> dokuments;
  late int success;
  late int failed;

  Document({required this.dokuments, required this.success, required this.failed});

  Document.fromJson(Map<String, dynamic> json) {
    if (json['dokuments'] != null) {
      dokuments = <Dokuments>[];
      json['dokuments'].forEach((v) {
        dokuments.add(Dokuments.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['dokuments'] = dokuments.map((v) => v.toJson()).toList();
